...
# 25MHz clock (MRCC)
set_property LOC U18 [get_ports CLK_25M]
...
# LEDs:
# Green LED to left of FPGA (LED1).  Not GPIO-capable
...
set_property LOC W13 [get_ports LED_GREEN] # GREEN LED (top)
  # 34 IO_L4N
set_property LOC W14 [get_ports LED_RED] # RED LED (bottom)
  # 34 IO_L8P
...
# 15  | GNSS_TX SIM33ELA
# 16  | CLK ???
#17-20| FPGA_DATA (unused)

# DATA connectors (20 pin, 2mm) (numbered l-r, t-b)
set_property LOC A20 [get_ports cm2300a_GPIO3] # DATA1-5
  # 35 IO_L2N  AD8N
set_property LOC H16 [get_ports cm2300a_SCLK] # DATA1-6
  # 35 IO_L13P MRCC
set_property LOC B19 [get_ports cm2300a_SDIO] # DATA1-7
  # 35 IO_L2P  AD8P
set_property LOC B20 [get_ports cm2300a_CSB]  # DATA1-8
  # 35 IO_L1N  AD0N
set_property LOC C20 [get_ports cm2300a_FCSB]    # DATA1-9
  # 35 IO_L1P  AD0P
set_property LOC H17 [get_ports sim33ela_3D_FIX] # DATA1-11
  # 35 IO_L13N MRCC
set_property LOC D20 [get_ports sim33ela_PPS]    # DATA1-13
  # 35 IO_L4N
set_property LOC D18 [get_ports sim33ela_GNSS_RX] # DATA1-14
  # 35 IO_L3N  AD1N
set_property LOC H18 [get_ports sim33ela_GNSS_TX] # DATA1-15
  # 35 IO_L14N AD4N SRCC
set_property LOC D19 [get_ports DATA1_CLK] # DATA1-16
  # 35 IO_L4P
#set_property LOC F20 [get_ports DATA1_17] # unused DATA1-17
  # 35 IO_L15N AD12N
#set_property LOC E19 [get_ports DATA1_18] # unused DATA1-18
  # 35 IO_L5N  AD9N
#set_property LOC F19 [get_ports DATA1_19] # unused DATA1-19
  # 35 IO_L15P AD12P
#set_property LOC K17 [get_ports DATA1_20] # unused DATA1-20
  # 35 IO_L12P MRCC
