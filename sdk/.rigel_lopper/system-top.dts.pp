# 0 "/home/denis/YCC59_3238CQ1/sdk/platform/hw/sdt/system-top.dts"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/denis/YCC59_3238CQ1/sdk/platform/hw/sdt/system-top.dts"
/dts-v1/;
# 1 "/home/denis/YCC59_3238CQ1/sdk/platform/hw/sdt/zynq-7000.dtsi" 1
# 10 "/home/denis/YCC59_3238CQ1/sdk/platform/hw/sdt/zynq-7000.dtsi"
/ {
 #address-cells = <1>;
 #size-cells = <1>;
...
# 3 "/home/denis/YCC59_3238CQ1/sdk/platform/hw/sdt/system-top.dts" 2
# 1 "/home/denis/YCC59_3238CQ1/sdk/platform/hw/sdt/pl.dtsi" 1
/ {
 amba_pl: amba_pl {
  ranges;
  compatible = "simple-bus";
  #address-cells = <1>;
  #size-cells = <1>;
  firmware-name = "YCC59_328CQ1_top.bit.bin";
  clocking0: clocking0 {
...
# 4 "/home/denis/YCC59_3238CQ1/sdk/platform/hw/sdt/system-top.dts" 2
# 1 "/home/denis/YCC59_3238CQ1/sdk/platform/hw/sdt/pcw.dtsi" 1
 &ps7_cortexa9_0 {
 ...
 &nfc0 {
  arm,nand-cycle-t5 = <0>;
  xlnx,nand-clk-freq-hz = <100000000>;
  arm,nand-cycle-t6 = <0>;
  xlnx,nand-width = <8>;
  nand-bus-width = <8>;
  xlnx,ip-name = "ps7_nand";
  xlnx,nand-cycle-t0 = <11>;
  xlnx,nand-cycle-t1 = <11>;
  xlnx,nand-cycle-t2 = <1>;
  xlnx,nand-cycle-t3 = <1>;
  xlnx,nand-cycle-t4 = <1>;
  xlnx,nand-cycle-t5 = <1>;
  arm,nand-cycle-t0 = <1>;
  xlnx,nand-cycle-t6 = <1>;
  arm,nand-cycle-t1 = <1>;
  status = "okay";
  arm,nand-cycle-t2 = <0>;
  arm,nand-cycle-t3 = <0>;
  arm,nand-cycle-t4 = <0>;
  xlnx,name = "ps7_nand_0";
 };
 &smcc {
  xlnx,sram-chip-sel1 = <0>;
  xlnx,nor-chip-sel1 = <0>;
  xlnx,addr25 = <0>;
  status = "okay";
  nand-bus-width = <8>;
  flashbase = <0xe000e000>;
  xlnx,ip-name = "ps7_smcc";
  xlnx,sram-chip-sel0 = <0>;
  xlnx,nor-chip-sel0 = <0>;
  xlnx,name = "ps7_smcc_0";
 };
 &sdhci0 {
  xlnx,has-power = <0>;
  status = "okay";
...
# 5 "/home/denis/YCC59_3238CQ1/sdk/platform/hw/sdt/system-top.dts" 2
/ {
 device_id = "7z010";
 slrcount = <1>;
 family = "Zynq";
 ...
 cpus_a9: cpus-a9@0 {
  ...
  address-map = <0xf0000000 &amba 0xf0000000 0x10000000>,
         ...
         <0x00100000 &ps7_ddr_0_memory 0x00100000 0xFF00000>,
         ...
         <0xe1000000 &nfc0 0xe1000000 0x1000000>,
         ...
         <0xe000e000 &smcc 0xe000e000 0x1000>,
